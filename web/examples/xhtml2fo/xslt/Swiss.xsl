...
<xsl:stylesheet version="1.0"
  ...
  <xsl:attribute-set name="page-header">
    ...
    <xsl:attribute name="font-family">Myriad Web, Arial, Helvetica, sans-serif</xsl:attribute>
  ...
  <xsl:attribute-set name="thead" use-attribute-sets="inside-table">
    <xsl:attribute name="font-family">Myriad Web, Syntax, sans-serif</xsl:attribute>
    <xsl:attribute name="font-size-adjust">0.48</xsl:attribute>
  </xsl:attribute-set>
