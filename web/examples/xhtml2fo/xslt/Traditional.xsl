...
<xsl:stylesheet version="1.0"
  ...
  <xsl:param name="column-gap">24pt</xsl:param>
  ...
  <xsl:attribute-set name="body">
    ...
    <xsl:attribute name="font-family">Georgia, Minion Web, Palatino, Book Antiqua, Utopia, Times New Roman, serif</xsl:attribute>
  ...
  <xsl:attribute-set name="p">
    ...
    <xsl:attribute name="text-indent">1.75em</xsl:attribute>
  </xsl:attribute-set>
