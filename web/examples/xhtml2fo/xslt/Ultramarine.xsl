...
<xsl:stylesheet version="1.0"
  ...
  <xsl:attribute-set name="body">
    ...
    <xsl:attribute name="color">#F5F5F5</xsl:attribute>
    <xsl:attribute name="background">#000066</xsl:attribute>
  ...
  <xsl:attribute-set name="h1">
    ...
    <xsl:attribute name="color">#FFCC00</xsl:attribute>
  ...
  <xsl:attribute-set name="table">
    <xsl:attribute name="border-color">#336699</xsl:attribute>
    <xsl:attribute name="text-align">start</xsl:attribute>
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="del">
    <xsl:attribute name="text-decoration">line-through</xsl:attribute>
    <xsl:attribute name="background">#660000</xsl:attribute>
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="a-link">
    <xsl:attribute name="text-decoration">none</xsl:attribute>
    <xsl:attribute name="font-weight">bold</xsl:attribute>
    <xsl:attribute name="color">#FF6633</xsl:attribute>
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="mtb">
    ...
    <xsl:attribute name="border-before-color">#336699</xsl:attribute>
  </xsl:attribute-set>
