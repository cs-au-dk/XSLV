...
<xsl:stylesheet version="1.0"
  ...
  <xsl:attribute-set name="page-header">
    ...
    <xsl:attribute name="font-size-adjust">0.4</xsl:attribute>
  ...
  <xsl:attribute-set name="del">
    <xsl:attribute name="text-decoration">line-through</xsl:attribute>
    <xsl:attribute name="background">#FFCC66</xsl:attribute>
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="ins">
    ...
    <xsl:attribute name="background">#99FF33</xsl:attribute>
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="warning">
    ...
    <xsl:attribute name="font-style">normal</xsl:attribute>
    <xsl:attribute name="font-weight">bolder</xsl:attribute>
    <xsl:attribute name="background">#FFFF00</xsl:attribute>
