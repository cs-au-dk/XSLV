 ...
 * @author snk
 */
public class LiteralResultsTest extends SimplificationTestCase {
  public LiteralResultsTest() throws Exception {
    super(LiteralResultsTest.class.getSimpleName(), TEST_PATH
        + "literals/literals.xsl");
  ...
  public static void main(String[] args) {
    TestRunner.run(LiteralResultsTest.class);
  }
}
