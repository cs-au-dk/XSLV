...
<xsl:template match="d:sect1" mode="toc">
  ...
  <xsl:if test="$toc.section.depth > 1 
    ...
    <fo:block id="toc.{$cid}.{$id}">
      ...
      <xsl:apply-templates select="d:sect2" mode="toc">
        <xsl:with-param name="toc-context" select="$toc-context"/>
      </xsl:apply-templates>
    </fo:block>
  </xsl:if>
...
<xsl:template match="d:sect2" mode="toc">
  ...
  <xsl:if test="$toc.section.depth > 2 
    ...
    <fo:block id="toc.{$cid}.{$id}">
      ...
      <xsl:apply-templates select="d:sect3" mode="toc">
        <xsl:with-param name="toc-context" select="$toc-context"/>
      </xsl:apply-templates>
    </fo:block>
  </xsl:if>
...
<xsl:template match="d:sect3" mode="toc">
  ...
  <xsl:if test="$toc.section.depth > 3 
    ...
    <fo:block id="toc.{$cid}.{$id}">
      ...
      <xsl:apply-templates select="d:sect4" mode="toc">
        <xsl:with-param name="toc-context" select="$toc-context"/>
      </xsl:apply-templates>
    </fo:block>
  </xsl:if>
...
<xsl:template match="d:sect4" mode="toc">
  ...
  <xsl:if test="$toc.section.depth > 4 
    ...
    <fo:block id="toc.{$cid}.{$id}">
      ...
      <xsl:apply-templates select="d:sect5" mode="toc">
        <xsl:with-param name="toc-context" select="$toc-context"/>
      </xsl:apply-templates>
    </fo:block>
  </xsl:if>
