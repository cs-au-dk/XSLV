...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
      ...
      <body>
        <div style="display:block">
          <div class="float">
            <img onclick="return select_prev()" src="left.gif" alt="bla"/>
            <img onclick="return select_up()" src="up.gif" alt="bla"/>
            <img onclick="return select_next()" src="right.gif" alt="bla"/>
          </div>
  ...
  <xsl:template match="systemresponse/text()">
    ...
    <!-- <xsl:apply-templates select="elide"/> -->
  </xsl:template>
  ...
  <xsl:template match="figure">
    <div class="figure"><img src="{@src}" alt="bla"/></div>
  </xsl:template>
  ...
  <xsl:template match="systemresponse">
  </xsl:template>
