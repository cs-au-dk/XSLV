...
<xsl:stylesheet version="1.0"
  ...
  <xsl:param name="writing-mode">tb-rl</xsl:param>
  ...
  <xsl:attribute-set name="body">
    ...
    <xsl:attribute name="font-family">Times New Roman, MS Mincho, "ＭＳ 明朝", serif</xsl:attribute>
    <xsl:attribute name="font-size-adjust">0.5</xsl:attribute>
    <xsl:attribute name="color">black</xsl:attribute>
    <xsl:attribute name="background">#FFFFF5</xsl:attribute>
  ...
  <xsl:attribute-set name="page-header">
    ...
    <xsl:attribute name="font-family">Arial, MS Gothic, "ＭＳ ゴシック", sans-serif</xsl:attribute>
  ...
  <xsl:attribute-set name="blockquote">
    ...
    <xsl:attribute name="start-indent">inherited-property-value(start-indent) + 1.75em</xsl:attribute>
    <xsl:attribute name="end-indent">inherit</xsl:attribute>
  </xsl:attribute-set>
  
  <xsl:attribute-set name="pre">
    <xsl:attribute name="font-family">Courier New, MS Gothic, "ＭＳ ゴシック", monospace</xsl:attribute>
  ...
  <xsl:attribute-set name="address">
    ...
    <xsl:attribute name="space-after.optimum">1.75em</xsl:attribute>
  ...
  <xsl:attribute-set name="ul-label-1">
    <xsl:attribute name="font">0.67em sans-serif</xsl:attribute>
  ...
  <xsl:param name="ol-label-1">１</xsl:param>
  <xsl:attribute-set name="ol-label-1">
    <xsl:attribute name="font">1em sans-serif</xsl:attribute>
    <xsl:attribute name="alignment-baseline">central</xsl:attribute>
  </xsl:attribute-set>
  
  <xsl:param name="ol-label-2">(イ)</xsl:param>
  <xsl:attribute-set name="ol-label-2">
    <xsl:attribute name="font">0.83em sans-serif</xsl:attribute>
    <xsl:attribute name="alignment-baseline">central</xsl:attribute>
  </xsl:attribute-set>
  
  <xsl:param name="ol-label-3">(１)</xsl:param>
  ...
  <xsl:attribute-set name="stb">
    ...
    <xsl:attribute name="space-before.optimum">0.83em</xsl:attribute>
    <xsl:attribute name="space-before.maximum">1em</xsl:attribute>
    <xsl:attribute name="padding-before">0.83em</xsl:attribute>
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="mtb">
    ...
    <xsl:attribute name="border-before-color">#999999</xsl:attribute>
  </xsl:attribute-set>
